function loginPage(){
  ...
  <div class="mainContent">
      ...
      <div class="forGoogle">
          <a class="forGoogleClick" href="#"><span><img id="googleIcon" src="./images/googleLogo.png" alt=""></span>Login with Google</a>
      </div>
      <div class="forOr">
          ...
          <div class="inputModel">
              <form>
                  <p id="email">Email</p>
                  <input class="inputs" id="emailLogin" type="email" placeholder="jhon@example.com">
                  <div id="emailMessage">
                      <p id="emailNameAlert"><img id="alertImg" src="./images/alert.png"> This field is required</p>
                  </div>
                  <p id="password">Password</p>
                  <input class="inputs" id="passwordLogin"  type="password" placeholder="Must be atleast 6 characters">
                  <div id="passMessage">
                  ...
                  <a  href="#"><button id="buttonLogin" class="loginButton">Login</button></a>
                  <div class="newUser">
